...
function RelaxingBreathTimer({ name = '4-7-8 Breathing', autoMaximize = false, autoStart = false, showBackButton = true, onBackClick }) {
  ...
  return (
    <div
      className={`relaxing-breath-timer ${currentPhaseConfig.color} ${isMaximized ? 'maximized' : ''}`}
