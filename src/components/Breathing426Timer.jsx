...
function Breathing426Timer({ name = '4-2-6 Breathing', autoMaximize = false, autoStart = false }) {
  ...
  return (
    <div 
      className={`breathing-426-timer ${currentPhaseConfig.color} ${isMaximized ? 'maximized' : ''}`}
      onClick={(e) => {
...
export default Breathing426Timer